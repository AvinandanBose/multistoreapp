          ...
          itemBuilder: (context, index) {
            return GestureDetector(
              onTap: (){
                ...
                pgcontroller.jumpToPage(index);//→Controllers helps to select the index and jump to the page according to its index number
                ...
                // //first initialize all elements in items to false
                // for (var element in items){
                //   element.isSelected = false;
                // }
                // //then change the boolean variable for selected index of the list to true
                // setState(() {
