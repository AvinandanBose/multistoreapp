...
<h3><li>5 k)  Welcome Screen [mainscreen/welcomescreen] </li> </h3>
 ...
 <h3><li>5 l) a) Navigator.push vs Navigator.pushReplacement(mainscreen/welcomescreen) </li></h3>
   <ul>
    ...
    <h3> Note : Navigator.push remembers the previous page(i.e. doesnot dispose off the previous route) and provides extra back button to go back (to the previous route)but Navigator.pushReplacement replaces the current page(dispose off the previous route and then enters the new route) with a new and hence there is no back button to go back to the previous page. </h3>
    </ul>
  </ul>
 </ul>
